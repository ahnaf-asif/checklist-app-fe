    ...
    <Layout showSidebar>
      ...
      <Tabs defaultValue="enrolled">
        <Tabs.List>
          ...
          <Tabs.Tab value="unenrolled">Unenrolled</Tabs.Tab>
          <Tabs.Tab value="all">All</Tabs.Tab>
        </Tabs.List>

        <Space h="md" />

        <Tabs.Panel value="enrolled">{getChecklistItems('enrolled')}</Tabs.Panel>

        <Tabs.Panel value="unenrolled">{getChecklistItems('unenrolled')}</Tabs.Panel>

        <Tabs.Panel value="all">{getChecklistItems('all')}</Tabs.Panel>
      </Tabs>
